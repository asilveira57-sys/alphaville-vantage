...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,400;0,500;0,600;0,700;1,400&family=Cormorant+Garamond:ital,wght@0,400;0,500;0,600;0,700;1,400&family=Inter:wght@300;400;500;600;700;800&display=swap",
      },
    ],
    scripts: [
      {
...
function RootShell({ children }: { children: ReactNode }) {
  return (
    <html lang="pt-BR">
      ...
      <body>
        {/* Meta Pixel — fallback noscript (obrigatório ficar no body) */}
        <noscript>
          <img
            height="1"
            width="1"
            style={{ display: "none" }}
            src="https://www.facebook.com/tr?id=1331471408906765&ev=PageView&noscript=1"
            alt=""
          />
        </noscript>
        {children}
