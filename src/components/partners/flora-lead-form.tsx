...
const PLANS = [
  "Apartamento de 420 m²",
  "Apartamento de 565 m²",
  "Cobertura duplex de 815 m²",
  "Cobertura triplex de 835 m²",
  "Quero comparar as tipologias",
];
    ...
    try {
      await submit({
        data: {
          ...
          empreendimento_slug: "flora-alphaville",
          conversion_context: "empreendimento_flora",
