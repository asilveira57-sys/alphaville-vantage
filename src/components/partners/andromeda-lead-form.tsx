...
const PLANS = ["Planta de 90 m²", "Planta de 123 m²", "Quero comparar as duas"];
...
export function AndromedaLeadForm() {
    ...
    try {
      await submit({
        data: {
          ...
          empreendimento_slug: "andromeda-by-mpd",
          conversion_context: "empreendimento_andromeda",
  ...
  return (
    <form onSubmit={onSubmit} className="grid gap-4 sm:grid-cols-2">
      ...
      />
      <select className={field} value={form.development} onChange={set("development")} aria-label="Planta de interesse">
        {PLANS.map((d) => (
